...
function group(
  ...
  return { id, supportedEventTypes, categoryKey, name, defaultMaxSelections, freeIncludedCount, requiresApprovalAfterLimit, approvalMessage, displayOrder, active: true };
}
...
export const MOCK_CATALOG_GROUPS: CatalogGroup[] = [
  ...
  group('cat-welcome-drinks', ['wedding'], 'catering', 'Welcome Drinks', 1, 1, true, 'Additional Welcome Drinks require vendor approval.', 1),
  group('cat-starters', ['wedding'], 'catering', 'Starters', 2, 2, true, 'You have reached the allowed number of starters for your package.', 2),
  group('cat-main-course', ['wedding'], 'catering', 'Main Course', null, 0, false, null, 3),
  group('cat-rice', ['wedding'], 'catering', 'Rice Items', null, 0, false, null, 4),
  group('cat-breads', ['wedding'], 'catering', 'Indian Breads', null, 0, false, null, 5),
  group('cat-curries', ['wedding'], 'catering', 'Curries', null, 0, false, null, 6),
  group('cat-live-counters', ['wedding'], 'catering', 'Live Counters', 2, 1, false, null, 7),
  group('cat-desserts', ['wedding'], 'catering', 'Desserts', null, 0, false, null, 8),
  group('cat-ice-cream', ['wedding'], 'catering', 'Ice Cream', 1, 1, false, null, 9),
  group('cat-beverages', ['wedding'], 'catering', 'Beverages', null, 0, false, null, 10),
  group('cat-special-items', ['wedding'], 'catering', 'Special Items', null, 0, false, null, 11),
  group('cat-general', ['engagement', 'reception', 'birthday', 'anniversary', 'get_together', 'bachelor_party', 'housewarming', 'haldi_function', 'corporate_event', 'traditional_home_function', 'other_events'], 'catering', 'Catering', 1, 1, false, null, 12),
