    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-16">
      ...
      <div className="text-center space-y-4 max-w-3xl mx-auto">
        ...
        <p className="text-maroon-700/80 text-base">
          Notes from couples and families we&apos;ve planned weddings for over the past few seasons.
        </p>
        <TraditionalBorder />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {MOCK_TESTIMONIALS.map((t) => (
          <GlassCard key={t.id} variant="warm" className="flex flex-col justify-between space-y-6 relative p-8">
            ...
            <div className="flex items-center gap-4 pt-4 border-t border-gold-300">
              ...
              <div>
                ...
                <p className="text-xs text-maroon-700">{t.location} • {t.weddingDate}</p>
